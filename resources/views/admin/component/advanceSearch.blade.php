    ...
    <div class="col-12">
        <div class="collapse" id="collapseExample">
            <div class="card card-body">
                <H6 class="text-primary">Advance Search</H6>
                <div class="row">
                    <div class="col-12">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-10">
                                                    ...
                                                    <select
                                                        ...
                                                        data-select2-id="{{ $item->filed_name }}" tabindex="-1"
                                                        aria-hidden="true"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-10">
                                                    ...
                                                    <input type="text" class="form-control padding_form"
                                                        id="{{ $item->filed_name }}" {{-- placeholder="{{ $item->filed_name }}" --}}
                ...
                <div class="row">
                    <div class="col-12 mt-2">
                        <span class="badge bg-success">You can setup your schedule for export this data to email or
                            telegram !</span> <br><br>
                        <button class="btn btn-primary ladda-button" data-prefix = '{{ $prefix }}'
                            onclick="searchData(this)"><span class="ladda-label">Search</span></button>
                        <button class="btn btn-outline-danger ladda-button" data-prefix = '{{ $prefix }}'
                            onclick="exportAndSearch(this)"><span class="ladda-label">Scheduling Export
                                Excel</span></button>
                    </div>
                </div>
            </div>
