...
<head>
    ...
    <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="{{asset('/ecom-asset/img/apple-touch-icon-144x144-precomposed.png')}}">
    ...
    <link href="{{asset('ecom-asset/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('/ecom-asset/css/style.css')}}" rel="stylesheet">
	<link href="{{asset('/ecom-asset/css/custom.css')}}" rel="stylesheet">
    <link href="{{asset('/ecom-asset/css/home_1.css')}}" rel="stylesheet">
...
<body>
		...
		<ul id="banners_grid" class="clearfix">
			<li>
				<a href="#0" class="img_container">
					<img src="{{asset('ecom-asset/img/banners_cat_placeholder.jpg')}}" data-src="img/banner_1.jpg" alt="" class="lazy">
			...
			<li>
				<a href="#0" class="img_container">
					<img src="{{asset('ecom-asset/img/banners_cat_placeholder.jpg')}}" data-src="img/banner_2.jpg" alt="" class="lazy">
					<div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
			...
			<li>
				<a href="#0" class="img_container">
					<img src="{{asset('ecom-asset/img/banners_cat_placeholder.jpg')}}" data-src="img/banner_3.jpg" alt="" class="lazy">
					<div class="short_info opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.5)">
			...
			<div class="row small-gutters">
				...
				<div class="col-6 col-md-4 col-xl-3">
					<div class="grid_item">
						...
						<figure>
							<a href="product-detail-1.html">
								<img class="img-fluid lazy" src="{{asset('ecom-asset/img/products/product_placeholder_square_medium.jpg')}}" data-src="{{asset('ecom-asset/img/products/shoes/8.jpg')}}" alt="">
								<img class="img-fluid lazy" src="{{asset('img/products/product_placeholder_square_medium.jpg')}}" data-src="img/products/shoes/8_b.jpg" alt="">
							</a>
						</figure>
    ...
    <link href="{{asset('/ecom-asset/js/common_scripts.js')}}" rel="stylesheet">
	<link href="{{asset('/ecom-asset/js/main.js')}}" rel="stylesheet">
    <link href="{{asset('/ecom-asset/js/carousel-home.min.js')}}" rel="stylesheet">
</body>
</html>