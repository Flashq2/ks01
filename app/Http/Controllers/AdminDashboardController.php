...
class AdminDashboardController extends Controller
{
    ...
    function __construct()
    {
        ...
        $this->blade_path = 'admin.dashboard.dashboard';
    ...
    public function index()
    {
        ...
        $total_customer = CustomerModels::count();
        $total_vendor = VendorModels::count();
        $total_user = UsersModels::count();
        $slide_show = SlideShowModels::get();
        $r_customer = CustomerModels::limit(7)->get(); $un_reads = MessageModel::where('from_user','<>','pokputhea2@gmail.com')->limit(6)->get();
        $total_employee = 0;
        $param = [
            'page' => $page,
            'tabe_id' => $tabe_id,
