...
(function (factory) {
    ...
    HideShowPassword.prototype = {
            ...
            if (options.enable) {
                ...
                if (options.toggle.position === "infer") {
                    options.toggle.position =
                        this.element.css("text-direction") === "rtl"
                            ? "left"
                            : "right";
                }
        ...
        isType: function (comparison, states) {
            ...
            comparison =
                comparison || this.state(undef, undef, states).props.type;
